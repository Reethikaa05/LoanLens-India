...
export const SignupPage: React.FC<SignupPageProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (matched) {
      ...
      const display = name.trim() || (email ? email.split('@')[0] : 'Borrower');
  ...
  return (
    <div className="min-h-screen w-full bg-[#0A070D] text-[#EEE6EA] flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-900/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[600px] h-[600px] bg-purple-900/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-5xl bg-[#140F18]/90 backdrop-blur-2xl rounded-[2.5rem] border border-white/10 shadow-[0_30px_100px_rgba(0,0,0,0.85)] overflow-hidden flex flex-col lg:flex-row items-stretch">
        ...
        {/* LEFT COLUMN: Clean Direct Sign Up Form */}
        <div className="w-full lg:w-1/2 p-6 sm:p-12 flex flex-col justify-between space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/[0.04] border border-white/10 text-[10px] font-mono text-neutral-400">
              ...
              <span>Dedicated Route: /signup</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              Join Borrower Copilot
            </h1>
            <p className="text-xs sm:text-sm text-neutral-400 font-light leading-relaxed">
              Create an autonomous counter-underwriting account. 100% in-browser memory with zero bureau hard inquiries.
            </p>
          </div>
          ...
          <div className="space-y-2.5 p-4 rounded-2xl bg-white/[0.03] border border-white/5 shadow-inner">
            <div className="flex items-center justify-between text-xs">
              <span className="flex items-center gap-1.5 text-neutral-300 font-medium">
                ...
                <span>1-Click Sample Persona:</span>
              </span>
              <span className="text-[10px] text-neutral-500 font-mono">Fills name & email</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2.5 cursor-pointer select-none text-[11px] text-neutral-400">
                <input
                  type="checkbox"
                  required
                  checked={agreed}
                  onChange={(e) => setAgreed(e.target.checked)}
                  className="mt-0.5 rounded border-neutral-700 bg-neutral-900 text-purple-600 focus:ring-0 cursor-pointer accent-purple-500"
                />
                <span className="leading-snug">
                  I agree to the <strong className="text-neutral-300">100% In-Browser Privacy Guarantee</strong> (zero data auctioned to DSAs; zero bureau hard pulls).
                </span>
              </label>
            </div>
          ...
          <div className="relative w-full h-full min-h-[580px] rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-neutral-950 flex flex-col justify-between">
            ...
            <div className="relative z-10 p-8 space-y-3">
              <h3 
                ...
                style={{ fontFamily: "'Instrument Serif', serif" }}
              >
                Level the playing field before you enter the bank.
              </h3>
              <p className="text-neutral-300 text-xs font-light leading-relaxed">
                Empower your loan negotiation with institutional counter-models. See what the lender conceals and borrow strictly on your own terms.
              </p>
              ...
              <div className="pt-2 flex items-center gap-4 text-[10px] font-mono text-neutral-400">
                ...
                <span className="flex items-center gap-1 text-cyan-300">
                  <LockKeyhole className="w-3 h-3" /> In-Memory Computation
                </span>
              </div>
            </div>
          </div>
